      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box box-primary">
            <form method="post" action="simpan_data_kph.php" enctype="multipart/form-data">
              <div class="box-body">
              ...
              <div class="row">
                    <div class="col-md-8">
                        <div class="form-group">
                            <label>Nama</label>
                            <input type="text" class="form-control" name="nama_kph" required="">
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="form-group">
                            <label>Potensi</label>
                            <textarea type="text" class="form-control" rows="5" name="potensi" required=""></textarea>
                        </div>
                    </div>
                </div>
